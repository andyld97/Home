...
Source: "bin\Release\net6.0-windows\publish\App.config"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\Release\net6.0-windows\publish\Home.Measure.Windows.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Measure.Windows.pdb"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Service.Windows.deps.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Service.Windows.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Service.Windows.dll.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Service.Windows.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Service.Windows.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Service.Windows.pdb"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net6.0-windows\publish\Home.Service.Windows.runtimeconfig.json"; DestDir: "{app}"; Flags: ignoreversion
